		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "View and Controller Exercise",
									"targetURL": "#day5exercise1gundaya-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"day5exercise1gundaya-display": {
								"semanticObject": "day5exercise1gundaya",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=day5exercise1gundaya",
									"url": sap.ui.require.toUrl("day5exercise1gundaya")
								}
							}
						}
					}
